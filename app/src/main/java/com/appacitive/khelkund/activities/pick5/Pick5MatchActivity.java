...
//        return details;
    ...
    public void onNextMatchClick() {
        StorageManager manager = new StorageManager();
        String nextMatchId = manager.getNextMatchId(getMatchDetails().getMatchDetails().getId());
        if (nextMatchId == null) {
    ...
    public void onPreviousMatchClick() {
        StorageManager manager = new StorageManager();
        String previousMatchId = manager.getPreviousMatchId(getMatchDetails().getMatchDetails().getId());
